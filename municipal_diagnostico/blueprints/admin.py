...
from municipal_diagnostico.services.module_access import ISO9001_ALLOWED_ROLES, WELLBEING_ALLOWED_ROLES, normalize_module_flags
...
def validate_user_payload(form_data, *, current_user_id: int | None = None, password_required: bool = True):
    ...
    if requested_iso9001 is not None and rol not in ISO9001_ALLOWED_ROLES:
        return None, "Diagnostico ISO 9001:2015 solo puede asignarse a administrador, revisor, evaluador o consulta."
